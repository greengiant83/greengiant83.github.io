...
AFRAME.registerComponent('link-controls',{
	...
	initURLView: function()
	{
		...
		urlEl.setAttribute('text',{color:'white',align:'center',font:'kelsonsans',value:'',width:0.5});
	...
	tooltips: 
	{
		'vive-controls':
		{
			...
			right:
			{
 				touchpad:
 				{
 					tooltip:'text: Press and hold touchpad to peek link;width: 0.1;height: 0.04;targetPosition: 0 0.05 0',position:'0.1 0.05 0.048',rotation:'-90 0 0'
 				},
 				trigger:
 				{
 					tooltip:'text: Press trigger to traverse link;width: 0.11;height: 0.04;targetPosition: 0 -0.06 0.06;lineHorizontalAlign: right;',
 					position:'-0.11 -0.055 0.04',rotation:'-90 0 0'
 				}
 			}
 		},
